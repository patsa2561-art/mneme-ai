...
const CONCEPTS: Concept[] = [
  ...
  { command: "mneme security", triggers: ["security audit", "appsec", "is this codebase secure", "security posture", "owasp", "vulnerabilities", "is this safe to ship", "ตรวจความปลอดภัย", "repo นี้ปลอดภัยไหม", "ช่องโหว่"] },
