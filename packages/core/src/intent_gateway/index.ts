...
const CONCEPTS: Concept[] = [
  ...
  { command: "mneme review", triggers: ["review this codebase", "full report", "codebase health", "audit the repo", "accountability report", "overall risk", "review my repo", "ตรวจโค้ดทั้งหมด", "รายงานสุขภาพโค้ด", "review repo"] },
  ...
  { command: "mneme testgap", triggers: ["whats untested", "test gap", "untested critical", "where to add tests", "is this tested", "am i editing untested code", "ยังไม่มี test ตรงไหน", "test ขาดตรงไหน", "ตรงไหนยังไม่เทส", "ควรเขียน test ตรงไหน"] },
