...
export const CLAIM_CATALOG: ReadonlyArray<Claim> = [
  ...
  },
  {
    ...
    kind: "boolean",
    asserted: { value: 1, op: "=", unit: "boolean" },
    probeId: "probe.mutagen.finds_guardrail_holes",
    severity: "block",
  },
  {
