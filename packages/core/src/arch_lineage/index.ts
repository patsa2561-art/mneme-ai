...
export function archLineageGauntlet(): ArchLineageGauntlet {
  ...
  const total = (() => { try { establishedIndex(0, () => false); establishedIndex(-1, () => true); return true; } catch { return false; } })();
  const checks = [
    ...
    { name: "TOTAL", pass: total, detail: "empty/negative n never throws" },
  ];
