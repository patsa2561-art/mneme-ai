  ...
  return createServer(async (req, res) => {
    ...
    if (req.method === "GET" && url.pathname === "/api/radar") {
      ...
      try {
        ...
        const EXT = /\.(ts|tsx|js|jsx|mjs|cjs|py|go|rs|rb|java|kt|cs|php|prisma|sql|md|mdx|markdown|txt)$/i;
