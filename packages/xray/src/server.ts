...
function personaLandingHtml(): string {
  ...
  const js = [
    ...
    "function card(p){var m=p.metrics,s=p.stats||{},tc=TC[p.tier]||'#9ca3af';",
    "  return '<div class=toon style=\"border-color:'+tc+'55\"><div class=stage><div class=avatar>'+p.avatarSvg+'</div></div>'+",
