...
const I18N: Record<Lang, Record<string, string>> = {
  en: {
    ...
    headline_post: ".",
    sub: "Mneme reads every commit and file in your project, builds a queryable memory of it, and verifies any answer about your code against the real evidence — so confidently-wrong claims get caught before they ship. Runs entirely on your machine. Free. Open source.",
    cta_npm: "npm install",
    cta_github: "GitHub →",
  ...
  th: {
    ...
    headline_post: ".",
    sub: "Mneme อ่านทุก commit และทุกไฟล์ในโปรเจคของคุณ แล้วสร้างความจำที่ค้นได้ พร้อมตรวจสอบทุกคำตอบเกี่ยวกับโค้ดของคุณกับหลักฐานจริง — เพื่อจับคำตอบที่ฟังดูมั่นใจแต่ผิด ก่อนที่มันจะหลุดถึง production · รันบนเครื่องคุณ 100% · ฟรี · Open source",
    cta_npm: "ติดตั้ง npm",
    cta_github: "GitHub →",
    cta_demo: "ลอง demo →",
    meta_tests: "tests",
