...
const VIEWS: Array<{ id: ViewMode; label: string; symbol: string; hint: string; group: ViewGroup }> = [
  ...
  { id: "timemachine",label: "Time Machine",   symbol: "🕰️",  hint: "Vendor honesty over time — line chart from pulse.jsonl. Did this AI get more honest or drift? Drag the window to 7/14/30/90 days.", group: "labs" },
  // History
